...
<c:if test="${param.username != NULL }">
 ...
 <sql:query dataSource="${ds}" sql="select * from users" var="results" />       
      ...
      <c:set var="empId" value="${sessionScope.user_to_delete}"/> 
...
<c:import url="header_logged_in_user.jsp">
        ...
        <div class="Event">  
            ...
            <div class="Event_back">
                 <strong><c:out value="${sessionScope.description[status.index]}"/> </strong>      
                    ...
                    <form action="PopulateEventDB" method="post">
                        
                            <input type="hidden" name="username" value="${username}"  />
                            <input type="hidden" name="email"    value="${email}"  />
                            <input type="hidden" name="date" value="${entry}"  />
                            <input type="hidden" name="year" value="${sessionScope.year}"  />
                            <input type="hidden" name="title1" value="${sessionScope.titles[status.index]}"  />
                            <input type="hidden" name="description" value="${sessionScope.description[status.index]}"  />                        
                            <input type="submit" value="Remind me" id="button"  />
...
<div id="questions">
    <form action="ParseEvents_logged_in_user" method="post" >
